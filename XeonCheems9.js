...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "923074060856") {
			let evaled,
				text = q,
...
case 'repo': case 'repository': {
	const githubRepoURL = 'https://i.imgur.com/j8Eqv2q.jpeg'
  try {
...
case 'addprem':
if (!XeonTheCreator) return XeonStickOwner()
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 923074060856`)
...
"sellerJid": "923074060856@s.whatsapp.net",
...
let e = String(err)
XeonBotInc.sendMessage("923074060856@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
